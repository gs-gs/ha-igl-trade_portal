CERT_SCHEMA = {
    ...
    "allOf": [{"$ref": "#/components/schemas/ExchangedDocument"}, {"type": "object"}],
    "required": ["isPreferential", "supplyChainConsignment"],
    "components": {
        "schemas": {
            "CrossBorderRegulatoryProcedure": {
                "type": "object",
                "properties": {"originCriteriaText": {"type": "string"}},
            },
            "DocumentAuthentication": {
                "description": "A proof that a document is genuine.",
                "type": "object",
                "properties": {
                    "actualDateTime": {"type": "string", "format": "date-time"},
            ...
            "ExchangedDocument": {
                ...
                "properties": {
                    ...
                    "firstSignatoryAuthentication": {
                        "allOf": [
                            {
                                "description": "The first or primary signature that authenticates this exchanged document."  # NOQA
                            },
            ...
            "SpecifiedBinaryFile": {
                ...
                "type": "object",
                "properties": {
                    "file": {"description": "missing description", "type": "string"},
                    "encodingCode": {
            ...
            "TradeAddress": {
                "type": "object",
                "properties": {
                    "line1": {"description": "missing description", "type": "string"},
                    "line2": {"description": "missing description", "type": "string"},
                    "cityName": {
                        "description": "The name, expressed as text, of the city, town or village of this trade address.",  # NOQA
                        "type": "string",
                    },
                    "postcode": {
            ...
            "Measure": {
                ...
                "type": "object",
                "properties": {
                    "uom": {"description": "missing description", "type": "string"},
                    "value": {"description": "missing description", "type": "string"},
                },
            },
        }
    },
